...
export const contractSchema = z.object({
  ...
  NgayKetThuc: z.string().nullable().optional().transform(v => v === "" ? null : v),
  NgayKy: z.string().nullable().optional().transform(v => v === "" ? null : v),
  ChucDanh: z.string().nullable().optional().transform(v => v === "" ? null : v),
  MaPB: z.string().nullable().optional().transform(v => v === "" ? null : v),
  MaLCB: z.string().nullable().optional().transform(v => v === "" ? null : v),
  MaPC: z.string().nullable().optional().transform(v => v === "" ? null : v),
  HinhThucTraLuong: z.string().nullable().optional().transform(v => v === "" ? null : v),
  TinhTrang: z.string().nullable().optional().transform(v => v === "" ? null : v),
}).refine(
  (data) => {
