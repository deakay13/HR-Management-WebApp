...
//PhongBan - HopDong
PhongBan.hasMany(HopDong, { foreignKey: "MaPB", as: "HopDong" });
HopDong.belongsTo(PhongBan, { foreignKey: "MaPB", as: "PhongBan" });

//LuongCoBan - HopDong
LuongCoBan.hasMany(HopDong, { foreignKey: "MaLCB", as: "HopDong" });
HopDong.belongsTo(LuongCoBan, { foreignKey: "MaLCB", as: "LuongCoBan" });

//PhuCap - HopDong
PhuCap.hasMany(HopDong, { foreignKey: "MaPC", as: "HopDong" });
HopDong.belongsTo(PhuCap, { foreignKey: "MaPC", as: "PhuCap" });
