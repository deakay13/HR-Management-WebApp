          ...
          <Dialog open={openCreate} onOpenChange={setOpenCreate}>
            ...
            <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                <FieldGroup>
                  <Field><Label htmlFor="MaHopDong">Mã hợp đồng</Label><Input id="MaHopDong" name="MaHopDong" placeholder="HD001" required /></Field>
                  <Field><Label htmlFor="MaNV">Mã nhân viên</Label><Input id="MaNV" name="MaNV" required /></Field>
                  <Field><Label htmlFor="LoaiHD">Loại hợp đồng</Label><Input id="LoaiHD" name="LoaiHD" required /></Field>
                  <Field><Label htmlFor="NgayBatDau">Ngày bắt đầu</Label><Input id="NgayBatDau" name="NgayBatDau" type="date" required /></Field>
                  <Field><Label htmlFor="NgayKetThuc">Ngày kết thúc</Label><Input id="NgayKetThuc" name="NgayKetThuc" type="date" required /></Field>
                  <Field><Label htmlFor="HinhAnhHopDong">Hình ảnh (File)</Label><Input id="HinhAnhHopDong" name="HinhAnhHopDong" type="file" /></Field>
                </FieldGroup>
