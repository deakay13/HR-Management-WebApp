...
export const columns: ColumnDef<Permission>[] = [
  {
    accessorKey: "MaQuyen",
    header: () => <div className="w-20 text-center">Mã Quyền</div>,
    cell: ({ row }) => (
      <div className="w-20 text-center h-8">{row.original.MaQuyen}</div>
    ),
  },
  {
    accessorKey: "TenQuyen",
    header: () => <div className="w-20 text-center">Tên Quyền</div>,
    cell: ({ row }) => (
      <div className="w-20 text-center h-8">{row.original.TenQuyen}</div>
    ),
  },
  {
    id: "actions",
