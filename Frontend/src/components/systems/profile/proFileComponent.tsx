  ...
  const handleUpdateInfo = async () => {
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        toast.error(
          t(firstErrorMessage) ||
            t("Vui lòng kiểm tra lại thông tin nhập vào."),
        );
      } else {
        ...
        <div className="relative flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="text-center md:text-left space-y-2">
            <h1 className="text-4xl font-bold tracking-tight">
              {employee?.HoVaTen || account?.TenTaiKhoan}
            </h1>
            ...
            <div className="flex items-center justify-between group">
              ...
              <span className="font-semibold text-foreground">
                {(() => {
                  ...
                  if (!dateVal) return "N/A";
                  /* If ISO format (contains T), reformat. Otherwise, display directly. */
                  return dateVal.includes("T")
                    ? new Date(dateVal).toLocaleDateString("vi-VN")
                    : dateVal;
                })()}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex flex-col items-center justify-center p-6 space-y-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              {previewUrl
                ? t("Nhấn vào ảnh để chọn lại")
                : t("Nhấn vào ảnh để chọn ảnh từ máy tính")}
            </p>
          </div>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>
              {editType === "personal"
                ? t("Sửa Thông Tin Cá Nhân")
                : t("Sửa Thông Tin Liên Hệ")}
            </DialogTitle>
            <DialogDescription>
              ...
              <>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditFormData((prev) =>
                        prev ? { ...prev, HoVaTen: e.target.value } : null,
                      )
                    }
                    className={errors.HoVaTen ? "border-red-500" : ""}
                  />
                  {errors.HoVaTen && (
                    <p className="text-xs text-red-500">{errors.HoVaTen}</p>
                  )}
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditFormData((prev) =>
                        prev ? { ...prev, NgaySinh: e.target.value } : null,
                      )
                    }
                    className={errors.NgaySinh ? "border-red-500" : ""}
                  />
                  {errors.NgaySinh && (
                    <p className="text-xs text-red-500">{errors.NgaySinh}</p>
                  )}
                </div>
              </>
            )}
              ...
              <>
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditFormData((prev) =>
                        prev ? { ...prev, SDT: e.target.value } : null,
                      )
                    }
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditFormData((prev) =>
                        prev ? { ...prev, DiaChi: e.target.value } : null,
                      )
                    }
